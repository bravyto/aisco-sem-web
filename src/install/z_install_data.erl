...
install_category(C) ->
    ...
    Cats = [
        ...
        % 115. Meta (see above)
            ...
            {117,115,92,2,92,92,predicate,true,undefined,[{title,{trans,[{en,<<"Predicate">>},{nl,<<"Predikaat">>}]}}]},{124,undefined,19,1,19,19,donation,false,"http://www.semanticweb.org/bravyto/ontologies/2016/10/charity-organization-ontology#Donation",[{title,{trans,[{en,<<"Donation">>}]}}]},{125,undefined,20,1,20,20,program,false,"http://www.semanticweb.org/bravyto/ontologies/2016/10/charity-organization-ontology#Program",[{title,{trans,[{en,<<"Program">>}]}}]}
    ],
...
install_predicate(C) ->
    ...
    Preds = [
		...
		[ 310, true,   "haspart",  "http://purl.org/dc/terms/hasPart",					?DB_PROPS([{reversed, false},{title, {trans, [{en,"Contains"}, {nl,"Bevat"}]}}])],[311,true,"channeled_through","http://www.semanticweb.org/bravyto/ontologies/2016/10/charity-organization-ontology#channeled_through",?DB_PROPS([{reversed,false},{title,{trans,[{en,"channeled_through"}]}}])]
    ],
	...
	[303, true, 102],
        ...
        [310, true,  120],[311,true,124],[311,false,125]
